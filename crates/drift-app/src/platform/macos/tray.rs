...
use objc2_app_kit::{
    NSApplication, NSControlStateValueOff, NSControlStateValueOn, NSMenu, NSMenuItem, NSStatusBar,
...
pub type TrayHandle = Retained<NSStatusItem>;
...
fn build_menu(
    ...
    let login_item = make_action_item(mtm, "Open at login", sel!(driftToggleLogin:), target_ptr);
